...
<?php
			...
			$query = mysql_query ("SELECT * FROM user",$konek);
			...
			<th align='center'><font color='white' face='Arial' size=4>Jenis Kelamin</font></th>
			<th align='center'><font color='white' face='Arial' size=4>Usia</font></th>
...
<?php
	$query = mysql_query ("SELECT * FROM film",$konek);
			$jumlah = mysql_num_rows($query);
			echo "<br><table border='0' cellpadding='1' cellspacing='1' bordercolor='black' bgcolor='black'>
			<tr bgcolor='#333' height='30'><font color='black'>
			<th align='center'><font color='white' face='Arial' size=4>No</font></th>
			...
			<th align='center'><font color='white' face='Arial' size=4>Jenis</font></th>
